...
public class RegisterDTO {
	...
	public static Register createEntity(@RequestParam int student_id,
			@RequestParam int  english_score, @RequestParam int math_score,@RequestParam int history_score,@RequestParam int  sum_score) throws IOException {
		...
		register.setSum_score(sum_score);
